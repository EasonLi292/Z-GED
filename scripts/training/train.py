"""
Training script for simplified topology-only circuit generation.
"""
...
def main():
    ...
    # Loss function (topology only)
    # Low KL weight (0.01) to allow topology separation in latent space
    # This lets the encoder maintain distinct latents for different topologies
    # (e.g., low_pass vs high_pass) even when transfer functions are similar
